...
from services.search_service import search_with_e2b_exa
...
class GenerateQuestionsRequest(BaseModel):
    ...
    numQuestions: Optional[int] = Field(default=3, ge=1, le=10, description="Number of questions to generate (1-10)")
    numAnswers: Optional[int] = Field(default=3, ge=2, le=6, description="Number of answer options per question (2-6)")
...
async def search_endpoint(request: SearchRequest):
    ...
    """
    try:
        # Call search service with E2B + Exa
